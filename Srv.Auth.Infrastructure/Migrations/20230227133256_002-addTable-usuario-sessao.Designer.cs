...
namespace Srv.Auth.Repository.Migrations
{
    ...
    [Migration("20230227133256_002-addTable-usuario-sessao")]
    partial class _002addTableusuariosessao
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Srv.Auth.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CpfCnpj = "12276789751",
                            CriadoEm = new DateTime(2023, 2, 27, 13, 32, 56, 542, DateTimeKind.Utc).AddTicks(1518),
                            Email = "thiago.prog@outlook.com",
                            Id = new Guid("ccae6ad0-04bf-4c46-b3d9-c3a4ad3a4499"),
